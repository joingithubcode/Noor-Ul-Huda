      ...
      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 items-stretch">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 flex flex-col justify-center hover:scale-[1.02] transition">
          ...
          <ul className="space-y-3 text-base leading-relaxed text-center">
            <li>
              <span className="font-medium">Name:</span> Noor ul Huda Abid
            </li>
            <li>
            ...
            <li>
              <span className="font-medium">Phone:</span> +92 333 9737818
            </li>
            <li>
              <span className="font-medium">LinkedIn:</span>{" "}
              <a
                href="https://www.linkedin.com/in/noor-ul-huda-abid"
                target="_blank"
            ...
            <li>
              <span className="font-medium">Address:</span> Lahore, Pakistan (54000)
            </li>
          </ul>
        </div>
